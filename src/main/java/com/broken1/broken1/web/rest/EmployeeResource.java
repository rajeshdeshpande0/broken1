...
import com.broken1.broken1.web.rest.errors.BadRequestAlertException;
import com.broken1.broken1.web.rest.util.HeaderUtil;
...
@CrossOrigin(origins = "*", allowedHeaders = "*") public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "broken1Employee";
